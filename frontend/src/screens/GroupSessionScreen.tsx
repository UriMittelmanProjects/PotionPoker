  ...
  const mockPlayers: GroupSessionPlayer[] = session ? [
    {
      ...
      userId: 'user1',
      user: { id: 'user1', email: 'john@example.com', username: 'john_poker', firstName: 'John', lastName: 'Smith', displayName: 'John S.' },
      buyIn: 200,
    ...
    },
    {
      ...
      groupSessionId: session.id,
      userId: 'user2',
      user: { id: 'user2', email: 'jane@example.com', username: 'jane_cards', firstName: 'Jane', lastName: 'Doe', displayName: 'Jane D.' },
      buyIn: 200,
